  ...
  return (
    <div>
      ...
      <p style={{ color: 'var(--gray-500)', marginBottom: 'var(--space-6)' }}>
        Complete the form below to apply as a voter. Your face scan will be used to verify your identity when you vote.
      </p>
      ...
      <div className="card">
        ...
        <form onSubmit={submit}>
          ...
          <div className="form-group">
            <label className="form-label">Identity Proof (upload image or PDF)</label>
            <input type="file" accept="image/*,.pdf" required onChange={e => setIdentityProof(e.target.files[0])} />
          </div>

          <div className="form-group">
            <FaceCapture label="Capture Your Face (used to verify you when voting)" onCapture={setFaceCapture} />
          </div>
